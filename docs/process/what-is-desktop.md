# What is Madness Desktop and who is it for?

### Purpose
As we triage issues, evaluate pull requests, and discuss new features, the Madness Desktop team is 
making decisions based on our vision for the Madness Desktop product. The purpose of this document 
is to transparently share our collective view of what Madness Desktop is and who we’re optimizing 
...
## 1. Madness Desktop reduces frustration and makes Git and GitHub workflows* more approachable.

Our goal with Madness Desktop is to remove frustration, awkward interactions, and “oh no” moments 
...
Git can be intimidating, and we want Madness Desktop to make interactions with Git easier and more 
approachable. Madness Desktop is not a replacement for the functionality of Git, but a tool to enable 
you and your team to be more productive.

## 2. Madness Desktop extends GitHub to your local environment.

Madness Desktop is built and maintained by a team at GitHub and a group of amazing community contributors 
...
## 3. Madness Desktop prioritizes workflows for beginners and collaborative teams.

We want to create an inclusive and approachable way for developers to turn ideas into reality, and we see 
Madness Desktop as critical in reducing the intimidation of working with Git on the command line. Users of 
all experience levels will continue to benefit from Madness Desktop’s features but when we have to choose 
...
This also means Madness Desktop will likely not support workflows that are unique to your team, against 
documented best practice, or different from the vast majority of developers.

## 4. Madness Desktop has a variety of people using it, but our core users are software developers.
...
## 5. Madness Desktop is a tool that enables you to learn while you get things done

Madness Desktop should be a helpful tool for beginner developers, but it is not explicitly a teaching tool. 
