...
Madness Desktop supports the user choosing an external program to open their
...
wishes to uninstall. These entries are used by Madness Desktop to identify
...
Now Madness Desktop support editors installed through JetBrains Toolbox.
...
identifier for Madness Desktop.
...
With this bundle identifier, Madness Desktop can obtain the install location of
the app.
