...
Now that we understand the components involved we can talk about the big picture. When Madness Desktop is about to perform a Git network operation such as `push`, `pull`, `fetch`, etc we follow this rough flow.
