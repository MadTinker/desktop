...
those are used in some dependencies used in Madness Desktop.

## Yarn

Follow [this guide](https://yarnpkg.com/en/docs/install) to install
a system-level `yarn` for your distribution. Madness Desktop uses a local version
...
and running Madness Desktop locally:
