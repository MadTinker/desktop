...
export class AppStore extends TypedBaseStore<IAppState> {
   ...
   * in their `%AppData%/Roaming/Madness Desktop/Preferences.js` denoted by the
        ...
        if (match === null) {
          this.emitError(
            new ExternalEditorError(
              `No suitable editors installed for Madness Desktop to launch. Install ${suggestedExternalEditor.name} for your platform and restart Madness Desktop to try again.`,
