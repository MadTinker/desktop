...
/**
 * The CLI action kinds this dialog can dispatch, in tab order. Narrower than
 * `CLIAction['kind']` — our fork's group/submodule/favorite actions take
 * structured arguments this dialog doesn't model, so the switches below stay
 * exhaustive over just these two.
 */
const tabs = ['open-repository', 'clone-url'] as const satisfies ReadonlyArray<
  CLIAction['kind']
>
