...
export const BrowserRedirectMessage =
  "Your browser will redirect you back to Madness Desktop once you've signed in. If your browser asks for your permission to launch Madness Desktop please allow it to."
