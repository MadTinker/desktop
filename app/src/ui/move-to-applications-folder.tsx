...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move Madness Desktop to the Applications folder?"
      ...
      >
        <DialogContent>
          <p>
            We've detected that you're not running Madness Desktop from the
            Applications folder of your machine. This could cause problems with
            the app, including impacting your ability to sign in.
          </p>
          <p>
            Do you want to move Madness Desktop to the Applications folder now?
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move Madness Desktop to the Applications folder in your machine and restart the app."
