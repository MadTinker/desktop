...
interface ISeamlessDiffSwitcherProps {
   ...
   *
   * Optional: read-only diff surfaces (upstream's Copilot conflict view, for
   * one) render a switcher without an editor callback to thread through.
   */
  // eslint-disable-next-line react/no-unused-prop-types
      ...
      <div className={className}>
        {diff !== null ? (
          <Diff
            ...
            onOpenInExternalEditor={
              isLoadingDiff ? noop : onOpenInExternalEditor ?? noop
            }
